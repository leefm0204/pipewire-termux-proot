...
if [ -z "" ]; then
  SOURCEDIR="/data/data/com.termux/files/home/pipewire-termux-proot/subprojects/wireplumber"
  BUILDDIR="/data/data/com.termux/files/home/pipewire-termux-proot/builddir/subprojects/wireplumber"
else
